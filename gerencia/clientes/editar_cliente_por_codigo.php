...
?>
    ...
    <tr> 
      ...
      <td width="32%"><input name="data_nasc" type="text" id="data_nasc" value="<? echo $data_nasc; ?>" size="15" maxlength="10"></td>
      <td width="16%">Sexo</td>
...
?>
    ...
    <tr>
      ...
      <td colspan="3"><input name="num_beneficio3" type="text" id="num_beneficio3" value="<? echo $num_beneficio3; ?>" size="12">
Tipo
  <select name="tipo_benef_3" id="select">
...
Tipo
  <select name="tipo_benef_4" id="select2">
