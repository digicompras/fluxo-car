...
$email_estabelecimento = $linha[46];
}
...
-->
  ...
  <span class="style1"><? echo $nome; ?></span><? echo " já está cadastrado no sistema $nfantasia!<br><br>Nº de Matrícula do Cliente: $codigo <br><br> Clique em PREENCHER PROPOSTA!";
//$reg=0;
}
else
{
echo "Cliente NÃO cadastrado na base da dados do sistema $nfantasia!<br><br> Clique em CADASTRAR CLIENTE!";
}
