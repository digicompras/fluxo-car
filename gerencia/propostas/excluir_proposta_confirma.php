...
<form name="form1" method="post" action="grava_proposta_excluida.php">

<table width="100%" border="0" cellspacing="4">
    <tr>
      <td colspan="4"><div align="center"><font color="#0000FF" size="4">EXCLUINDO PROPOSTA N&ordm; <strong><? echo $num_proposta; ?>
...
$senha = $_SESSION['senha'];
?>
        <input type="submit" name="Submit" value="Excluir Proposta"> 
