...
?>
    ...
    <tr> 
      ...
      <td width="33%"><font color="#0000FF"><? echo $valor_credito; ?></font>        <input name="valor_credito" type="hidden" id="valor_credito" value="<? echo $valor_credito; ?>">
        formato 0000.00(ponto) </td><td width="21%">Valor Liberado R$ </td>
...
?>
    ...
    <tr> 
      <td><div align="center">
        <input name="parc1" type="hidden" id="parc1" value="">
      </div></td>
      <td>      <div align="center">
        <input name="banco1" type="hidden" id="banco1" value="">
      </div></td>
      <td><div align="center">
        <input name="vencto1" type="hidden" id="vencto1" value="">
      </div></td>
      <td>      <div align="center">
        <input name="compra1" type="hidden" id="compra1" value="">
      </div></td>
    </tr>
    <tr>
      <td>Obs</td>
