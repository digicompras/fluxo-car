...
if($verificacao_status=="Proposta_Paga" or "Cancelada"){echo "Esta Proposta já está com o status definido em $verificacao_status!!<br><br> Sua alteração é indevida, por esse motivo você não terá permissão de alteração!!!...<br><br> fale com seu superior!";}
else{
$sql = "SELECT * FROM propostas where num_proposta = '$num_proposta'";
$res = mysql_query($sql);
$reg = 0;
...
<table width="100%"  border="0">
  <tr>
    <td width="28%"><form name="form1" method="post" action="informe_num_proposta_para_edicao_de_proposta.php">
      <?
$usuario = $_SESSION['usuario'];
$senha = $_SESSION['senha'];
?>
      <input type="submit" name="Submit32" value="Editar outra Proposta">
    </form></td>
    <td width="44%"><form name="form1" method="post" action="../principal.php">
        <?
$usuario = $_SESSION['usuario'];
$senha = $_SESSION['senha'];
?>
...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF">         
        <select name="estabelecimento_proposta" id="select4">
...
?>
      ...
      <td><strong><font color="#0000FF">                
        <select name="tipo_proposta" id="select9">
...
$senha = $_SESSION['senha'];
?>
<? if($verificacao_status<>"Proposta_Paga")if($verificacao_status<>"Cancelada"){echo '<input type="submit" name="Submit" value="Alterar dados da Proposta"> 
