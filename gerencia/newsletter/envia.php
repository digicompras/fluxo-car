...
$sql = "SELECT * FROM operadores where usuario = '$usuario' and senha = '$senha' and funcao = 'Gerente'";
$res = mysql_query($sql);
$reg = 0;
echo "<tr>";
...
$sql = "SELECT * FROM clientes where tipo = '$tipo' and estabelecimento = '$estab_pertence'";
$res = mysql_query($sql);
$reg = 0;
echo "<tr>";
while($linha=mysql_fetch_row($res)) {
...
<p>
<img border='0' src='http://www.federalcredito.com.br/img_newsletter/$foto'></p>
