...
$comando = "delete from `cx_saidas` where `cx_saidas`. `cod_contas_a_pagar` = '$cod_contas_a_pagar'";
...
?>
  ...
  <form name="form1" method="post" action="verifica_contas_pagas_por_periodo.php">
