...
<form action="grava_categoria.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="100%" border="0" cellspacing="10">
    ...
    <tr>
      <td width="11%">&nbsp;</td>
      <td colspan="2"><strong><font color="#0000FF" size="4">Tela de cadastro de Categorias de despesas!</font></strong></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr> 
      <td>&nbsp;</td>
      <td width="17%"><input name="categoria" type="text" id="categoria"></td>
      <td width="72%">&nbsp;</td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td colspan="2"><input type="submit" name="Submit" value="Gravar Categoria"></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td colspan="2">&nbsp;</td>
...
<table width="60%" border="0">
  <tr>
    ...
    <td colspan="2"><form name="form5" method="post" action="categorias_insert.php">
      <select name="categoria_pequisar" id="categoria_pequisar">
        <option selected></option>
        <?


    $sql = "select * from categorias_despesas group by categoria order by categoria asc";
...
$sql = "select * from categorias_despesas where categoria = '$categoria_pequisar' order by categoria asc";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
$reg++;
