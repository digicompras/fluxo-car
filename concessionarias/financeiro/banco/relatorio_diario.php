...
?>
      ...
      <td><form action="imprimir_hoje.php" method="post" name="form1" target="_blank">
            ...
            <td colspan="3"><div align="center">
              ...
              <table width="100%"  border="0">
                ...
                <tr bgcolor="#CCCCCC">
                  ...
                  <td colspan="2"><div align="center"><strong>EXTRATO BANCARIO</strong></div></td>
...
$sql = "SELECT * FROM bco_entradas where datepagto = '$hoje_norteamericano' and categoria_conta = 'Abertura de Caixa' order by codigo asc";
...
$sql = "SELECT * FROM bco_entradas where datepagto = '$hoje_norteamericano'  order by codigo asc";
...
$sql = "select sum(valor) as total_entradas from bco_entradas where datepagto = '$hoje_norteamericano'";
...
$sql = "SELECT * FROM bco_saidas where datepagto = '$hoje_norteamericano'  order by codigo asc";
...
$sql = "select sum(valor) as total_saidas from bco_saidas where datepagto = '$hoje_norteamericano'";
