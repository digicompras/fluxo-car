...
?>
  <tr>
    <td class="style21"><div align="center"><span class="style2 style2 style4"><strong><font color="#0000FF"><strong><? echo $modopagto; ?></strong></font></strong></span></div></td>
    <td class="style21"><div align="center"></div></td>
  </tr>
  <tr>
    <td class="style21"><div align="center"><span class="style6">
      <?
...
?>
    ...
    <td class="style21"><div align="center"><strong><font color="#0000FF"><strong>
      <?


$sql3 = "select sum(valor_a_receber) as totalcartao from contas_a_receber where cartao = '$cartao' and datacadastro = '$hoje_norteamericano'";
