...
$comando = "insert into prestacao_contas_antecipacoes(num_prestacao_contas,dataantecipacao,valorantecipacao,descricaoantecipacao,operadorantecipacao,cidadeantecipacao)

values('$cod_prestacao','$dataabertura','$saldoanterior','Saldo anterior','$operador_contas','$cidadeatuacao')";
mysql_query($comando,$conexao);
...
$comando = "insert into prestacao_contas_antecipacoes(num_prestacao_contas,dataantecipacao,valorantecipacao,descricaoantecipacao,operadorantecipacao)

values('$num_prestacao_contas','$dataantecipacao','$valorantecipacao','$descricaoantecipacao','$operadorantecipacao')";
mysql_query($comando,$conexao);
...
?>
  ...
  <tr>
    <td colspan="2"><form action="../relatorios/relatorio_semanal_de_despesas_jairo.php" method="post" name="form2" target="_blank" id="form14">
      <div align="center">
        <?
...
?>
        ...
        <? if($operador=="IVAN CAMPOS DE ARAUJO"){ echo "<input class='class01' type='submit' name='Submit5' value='Relatorio Despesas'>"; } ?>
        </div>
    </form></td>
    <td align="center">&nbsp;</td>
    <td align="center">&nbsp;</td>
...
<table width="100%" border="0">
  <tbody>
    <tr>
      ...
      <td width="30%" align="center">Saldo</td>
    </tr>
    <tr>
...
echo "R$ $saldo";
    ...
    <tr>
      <td colspan="3" valign="top"><table width="100%" border="1">
          ...
          <tr>
            <td colspan="3" align="center">Antecipa&ccedil;&atilde;o/Saldo Anterior</td>
          </tr>
          <tr>
            <td width="25%">Data</td>
  ...
  Valor
          ...
          <tr>
            <td valign="top"><input class='class02' name="dataantecipacao" type="text" id="dataantecipacao" size="5"></td>
            <td valign="top"><input class='class02' name="valorantecipacao" type="text" id="valorantecipacao" size="5"></td>
            <td valign="top"><textarea class='class02' name="descricaoantecipacao" id="descricaoantecipacao" cols="20" rows="1"></textarea></td>
          </tr>
          <tr>
...
?>
              <input class='class01' type="submit" name="Submit3" value="Salvar">
              <input name="solicitacao" type="hidden" id="solicitacao" value="gravarantecipacao">
              <input name="num_prestacao_contas" type="hidden" id="num_prestacao_contas" value="<? echo "$cod_prestacao"; ?>">
