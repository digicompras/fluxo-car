...
$sql = "select sum(valor) as total_liquido_recebimentos from cx_entradas where operador = '$operador' and nfantasia = '$estab_pertence' and datecadastro = '$datecadastro' order by datecadastro desc limit 1";
$resultado=mysql_query($sql, $conexao);
$linha=mysql_fetch_array($resultado);

$total_liquido_recebimentos = bcadd($linha['total_liquido_recebimentos'],$total_liquido_banco_entradas,2);
...
$sql = "select sum(valor) as total_liquido_saidas from cx_saidas where operador = '$operador' and nfantasia = '$estab_pertence' and datecadastro = '$datecadastro' order by datecadastro desc limit 1";
$resultado=mysql_query($sql, $conexao);
$linha=mysql_fetch_array($resultado);
...
CAIXA<BR>
DINHEIRO: R$ $total_liquido_dinheiro<br>
CARTOES: R$ $total_liquido_cartao<br>
CARTEIRA: R$ $total_liquido_carteira<br><br>

BANCO<BR>
BANCO ENTRADAS: $total_liquido_banco_entradas<br><br>

Total Geral Recebimento R$ $total_liquido_recebimentos<br><br>

---Total Geral Saidas---<br><br>

SAIDAS: R$ $total_liquido_saidas<br><br>
...
?>
      <input class="class01" type="submit" name="submit5" id="submit5" value="<? echo "$diasemana $diaatual-$mesatual-$anoatual"; ?>">
    </form></td>
...
?>
	...
	<section_movel>
		<? if($veiculos_autorizado=="nao"){ ?><div class="bloco_botoes_movel" style="display: none;">
		<? } else{ ?>	<div class="bloco_botoes_movel"><? } ?>
		...
		<? if($rdo_autorizado=="nao"){ ?><div class="bloco_botoes_movel" style="display: none;">
		<? } else{ ?>	<div class="bloco_botoes_movel"><? } ?>
			<? if( ($registro_de_abertura>=1) && ($registro_de_fechamento==0)  && ($funcao<>"Mecanico") ){ ?>
			<?
		...
		<? if($estoque_autorizado=="nao"){ ?><div class="bloco_botoes_movel" style="display: none;">
		<? } else{ ?>	<div class="bloco_botoes_movel"><? } ?>
			<? if( ($registro_de_abertura>=1) && ($registro_de_fechamento==0) && ($funcao<>"Mecanico") ){ ?>
			<?
		...
		<? if($conciliacoes_autorizado=="nao"){ ?><div class="bloco_botoes_movel" style="display: none;">
		<? } else{ ?>	<div class="bloco_botoes_movel"><? } ?>
			<? if( ($registro_de_abertura>=1) && ($registro_de_fechamento==0)  && ($funcao<>"Mecanico") ){ ?>
			<?
		...
		<? if($fornecedores=="nao"){ ?><div class="bloco_botoes_movel" style="display: none;">
		<? } else{ ?>	<div class="bloco_botoes_movel"><? } ?>
			<? if( ($registro_de_abertura>=1) && ($registro_de_fechamento==0)  && ($funcao<>"Mecanico") ){ ?>
			<?
				if($fornecedores=="sim"){
		...
		<? if(($abrir_e_fechar_cx=="nao") && ($funcao<>"Mecanico") ){ ?><div class="bloco_botoes_movel" style="display: none;">
		<? } else{ ?>	<div class="bloco_botoes_movel"><? } ?>
			<? if(($abrir_e_fechar_cx=="sim") && ($funcao<>"Mecanico") ){
		...
		<? if($controlekm_autorizado=="nao"){ ?><div class="bloco_botoes_movel" style="display: none;">
		<? } else{ ?>	<div class="bloco_botoes_movel"><? } ?>
			<? if( ($registro_de_abertura>=1) && ($registro_de_fechamento==0)  && ($funcao<>"Mecanico") ){ ?>
			<?
		...
		<? if($permissao_categoria_de_produtos=="nao"){ ?><div class="bloco_botoes_movel" style="display: none;">
		<? } else{ ?>	<div class="bloco_botoes_movel"><? } ?>
			<? if( ($registro_de_abertura>=1) && ($registro_de_fechamento==0) && ($funcao<>"Mecanico") ){ ?>
			<?
		...
		<? if($registrodeoperadores=="nao"){ ?><div class="bloco_botoes_movel" style="display: none;">
		<? } else{ ?>	<div class="bloco_botoes_movel"><? } ?>
			<? if( ($registro_de_abertura>=1) && ($registro_de_fechamento==0) && ($funcao<>"Mecanico") ){ ?>
			<?
		...
		<? if($despesas_autorizado=="nao"){ ?><div class="bloco_botoes_movel" style="display: none;">
		<? } else{ ?>	<div class="bloco_botoes_movel"><? } ?>
			<? if( ($registro_de_abertura>=1) && ($registro_de_fechamento==0) && ($funcao<>"Mecanico") ){ ?>
			<?
		...
		<? if($financeiro=="nao"){ ?><div class="bloco_botoes_movel" style="display: none;">
		<? } else{ ?>	<div class="bloco_botoes_movel"><? } ?>
			<? if( ($registro_de_abertura>=1) && ($registro_de_fechamento==0)  && ($funcao<>"Mecanico") ){ ?>
			<?
				if($financeiro=="sim"){
		...
		<? if($categoria_despesas=="nao"){ ?><div class="bloco_botoes_movel" style="display: none;">
		<? } else{ ?>	<div class="bloco_botoes_movel"><? } ?>
		...
		<? if($cadastro_de_contas_bancarias=="nao"){ ?><div class="bloco_botoes_movel" style="display: none;">
		<? } else{ ?>	<div class="bloco_botoes_movel"><? } ?>
			<? if( ($registro_de_abertura>=1) && ($registro_de_fechamento==0) ){ ?>
			<?
		...
		<? if($relatoriodecomissao=="nao"){ ?><div class="bloco_botoes_movel" style="display: none;">
		<? } else{ ?>	<div class="bloco_botoes_movel"><? } ?>
			<? if( ($registro_de_abertura>=1) && ($registro_de_fechamento==0) ){ ?>
			<?
