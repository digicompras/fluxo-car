...
$estab_pertence = $linha[44];
	$empresa_que_o_item_esta_cadastrado = $linha[44];
...
echo "	$produtos_encontrados peças encontradas!!!... Digite o nome da peça ou parte dela na caixa acima e clique em buscar para executar uma pesquisa por nome.";
...
?>
  ...
  <tr>
    ...
    <td align="center"><?
		if($inventario_autorizado=="sim"){ echo "Inventario Apura&ccedil;&atilde;o"; }else{ echo "Visulização das outras lojas"; }
										  ?>
										  </td>
...
$empresa_que_o_item_esta_cadastrado = $linha[43];
...
echo "*";
    ...
    <td width="22%"><div align="center"><form name="form3" method="post" action="menu.php#estoquefiliais">
		...
		<? if( ($operador_logado=="HEITOR MACHADO ARAUJO") or ($operador_logado=="ANA LUISA") or ($operador_logado=="JOAO PEDRO") ){ ?>
...
?>
  ...
  <?
if($visualizacao_para_outras_lojas=="Sim"){
		
$sql6 = "SELECT * FROM estabelecimentos where nfantasia <> '$empresa_que_o_item_esta_cadastrado' and cpf = '$cpf_proprietario'";
$res6 = mysql_query($sql6);
	$registros_nas_filiais = mysql_num_rows($res6);
	...
	if($registros_nas_filiais>=1){
			
		
	$sql8 = "select * from estoque_pecas where estab_pertence = '$estab_pertence_filial' and nome_produto = '$nome_produto'";	
$res8 = mysql_query($sql8);
$produtos_encontrados_na_estab_pertence_filial = mysql_num_rows($res8);

if($produtos_encontrados_na_estab_pertence_filial<=0){
...
values('$cod_barras','$cod_barras','$foto','$foto2','$material','$cor','$grupo','$sub_grupo','$descricao','$preco','$oferta','$preco_oferta','$data','$hora','$quant_estoque','$expedicao','$quant_disponivel','$quant_minima','$visualizacao_para_outras_lojas','$preco_compra','$frete','$margem_lucro_decimal','$impostos_decimal','$margem_lucro','$impostos','$nome_produto','$fornecedor','$travesseiro1','$travesseiro2','$margem_folga','$margem_folga_decimal','$descontomaximo','$classe','$departamento','$operador','$data','$hora','$estab_pertence_filial','$comissao_do_mecanico')";
        ...
        <tr>
          <th scope="row"><div id="estoquefiliais" class="modal2" role="dialog" style="overflow:  width: 640px; height: 400px; border:solid 0px"> <a href="#fechar" title="Fechar" class="fechar"><b>X</b></a>
            <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
				<?
$sql4 = "SELECT * FROM estabelecimentos where nfantasia <> '$empresa_que_o_item_esta_cadastrado' and cpf = '$cpf_proprietario' and classificacao <> '$classificacao' group by nfantasia order by classificacao asc";
...
$sql7 = "SELECT * FROM operadores where estab_pertence = '$estab_pertence_filial'";
