...
$sql = "SELECT * FROM veiculos where obra = '$obra_operador' and mobilizado = 'sim' and rdo = 'sim'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
$sql2 = "SELECT * FROM rdo where placa = '$placa' and data = '$data_atual' order by data asc";
...
$sql2 = "SELECT * FROM rdo where placa = '$placa' and data = '$data_informada' order by data asc";
$res2 = mysql_query($sql2);
$registros_rdo_lancamento = mysql_num_rows($res2);
