...
$data_de_ontem = date('Y-m-d', strtotime($data_ultimo_rdo_gerado. ' - 1 days'));
...
$sql10 = "SELECT * FROM rdo where localizacao = '$localizacao' and data <= '$data_de_hoje' group by data order by data desc limit 7";
...
$sql11 = "SELECT * FROM rdo where localizacao = '$localizacao' and data <= '$data_de_hoje' group by mes order by data desc limit 7";
$result11 = mysql_query($sql11);
while($x=mysql_fetch_array($result11)) {
