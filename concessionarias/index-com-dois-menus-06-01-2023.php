...
?>
		...
		if($relatoriodecomissao=="sim"){
			?>
        <input class='class01' type=image src="../imagens/botoes/relatorio.png" width="100" height="100" name="Submit5" value="Verificar Veiculos">
        <? } ?>
        <input name="senha2" type="hidden" id="senha2" value="<? echo $senha; ?>">
        <input class='class02' name="placa2" type="hidden" id="placa2">
        <input class='class02' name="localizacao2" type="hidden" id="localizacao2">
        <input class='class02' name="veiculo2" type="hidden" id="veiculo2">
    </form>      <? } ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
