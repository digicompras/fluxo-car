...
$sql = "SELECT * FROM fornecedores where nfantasia = '$nfantasia' limit 1";
...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr> 
      ...
      <td colspan="4"><strong>
        ...
        <input name="codigo_excluir" type="hidden" id="codigo2" value="<? echo $codigo; ?>">
    ...
    <tr>
      ...
      <td width="37%" colspan="2"><textarea class='class02' name="motivo_exclusao" cols="50" rows="6" id="motivo_exclusao"></textarea></td>
...
?>
        ...
        <input class='class01' type="submit" name="Submit" value="Excluir cadastro do Fornecedor"></td><td><div align="right"> </div></td>
