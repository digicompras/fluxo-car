...
<table width="100%" border="1" cellspacing="4">
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF">                         <? echo $dia_inicio_contrato; ?>
        <input name="dia_inicio_contrato" type="hidden" id="dia_inicio_contrato" value="<? echo $dia_inicio_contrato; ?>">
        /<? echo $mes_inicio_contrato; ?>
        <input name="mes_inicio_contrato" type="hidden" id="mes_inicio_contrato2" value="<? echo $mes_inicio_contrato; ?>">
        /        <? echo $ano_inicio_contrato; ?>
      ...
      <td><font color="#0000FF"><strong>                         <? echo $dia_termino_contrato; ?>
        <input name="dia_termino_contrato" type="hidden" id="dia_termino_contrato2" value="<? echo $dia_termino_contrato; ?>">
        /
        <? echo $mes_termino_contrato; ?>
        <input name="mes_termino_contrato" type="hidden" id="mes_termino_contrato2" value="<? echo $mes_termino_contrato; ?>">
        /
        <? echo $ano_termino_contrato; ?>
