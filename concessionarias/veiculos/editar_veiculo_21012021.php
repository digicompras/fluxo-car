...
?>
  ...
  <table width="100%" border="0">
    <tbody>
      <tr>
        <td width="8%" align="center"><form name="form3" method="post" action="pesquisa.php">
...
?>
        ...
        <td width="84%" align="center"><strong>EDI&Ccedil;&Atilde;O DE VEICULO/MAQUIN&Aacute;RIO</strong></td>
...
?>
      ...
      <input class='class02' name="localizacao2" type="hidden" id="localizacao2" value="<? echo $localizacao; ?>"></td>
...
?>
    ...
    <tr>
      <td>&nbsp;</td>
      <td colspan="3"><textarea class='class02' name="obs_veiculo" cols="50" rows="5" id="obs_veiculo"><? echo "$obs_veiculo"; ?></textarea>
        <span style="font-weight: bold">
...
?>
        <input class='class01' type="submit" name="Submit2" value="Salvar">
      </span></td>
    </tr>
  </table>
</form>
<table width="95%" border="0" align="center">
  <tbody>
    <tr>
      <td width="27%">&nbsp;</td>
      <td width="10%">&nbsp;</td>
      <td width="26%"><form action="etiqueta_pasta.php" method="post" name="form1" target="_blank">
        <div align="center">
          <input name="placa" type="hidden" id="placa" value="<? echo $placa; ?>">
          <? echo "<input class='class01' type='submit' name='Submit' value='Etiqueta'>"; ?>
        </div>
      </form></td>
      <td width="10%">&nbsp;</td>
      <td width="27%">&nbsp;</td>
