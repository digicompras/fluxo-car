...
?>
        <? if(($registro_abertura_de_caixa==1) && ($registro_fechamento_de_caixa==0) && ($reg_mensagem==0) && ($ultimo_departamento_trabalhado=="HAPPY HOUR") or ($registro_fechamento_de_caixa_de_ontem==0) && ($registro_fechamento_de_caixa==0) && ($reg_mensagem==0) && ($ultimo_departamento_trabalhado=="HAPPY HOUR") or ($reg_mensagem==0) && ($ultimo_departamento_trabalhado<>"") && ($funcao=="GERENTE")){ echo "<input type='submit' name='Submit5' value='Mapa de Mesas'>"; } ?>
        </div>
    </form></td>
...
?>
          <? if(($registro_abertura_de_caixa==1) && ($registro_fechamento_de_caixa==0) && ($reg_mensagem==0) && ($ultimo_departamento_trabalhado=="HAPPY HOUR") or ($registro_fechamento_de_caixa_de_ontem==0) && ($registro_fechamento_de_caixa==0) && ($reg_mensagem==0) && ($ultimo_departamento_trabalhado=="HAPPY HOUR") or ($reg_mensagem==0) && ($ultimo_departamento_trabalhado<>"") && ($funcao=="GERENTE")){ echo "<input type='submit' name='Submit5' value='Movimento'>"; } ?>
        </div>
      </form>
    </div></td>
...
?>
        <? if(($registro_abertura_de_caixa==1) && ($registro_fechamento_de_caixa==0) && ($reg_mensagem==0) && ($ultimo_departamento_trabalhado=="HAPPY HOUR") or ($registro_fechamento_de_caixa_de_ontem==0) && ($registro_fechamento_de_caixa==0) && ($reg_mensagem==0) && ($ultimo_departamento_trabalhado=="HAPPY HOUR") or ($reg_mensagem==0) && ($ultimo_departamento_trabalhado<>"") && ($funcao=="GERENTE")){ echo "<input type='submit' name='Submit5' value='CAIXA'>"; } ?>
      </div>
    </form></td>
    <td width="8%">&nbsp;</td>
...
?>
          <? if(($registro_abertura_de_caixa==1) && ($registro_fechamento_de_caixa==0) && ($reg_mensagem==0) && ($ultimo_departamento_trabalhado=="HAPPY HOUR") or ($registro_fechamento_de_caixa_de_ontem==0) && ($registro_fechamento_de_caixa==0) && ($reg_mensagem==0) && ($ultimo_departamento_trabalhado=="HAPPY HOUR") or ($reg_mensagem==0) && ($ultimo_departamento_trabalhado<>"") && ($funcao=="GERENTE")){ echo "<input type='submit' name='Submit5' value='Visualizar Caixa'>"; } ?>
        </div>
      </form>
    </div></td>
    <td>&nbsp;</td>
...
?>
          <? if(($registro_abertura_de_caixa==1) && ($registro_fechamento_de_caixa==0) && ($reg_mensagem==0) && ($ultimo_departamento_trabalhado=="HAPPY HOUR") or ($registro_fechamento_de_caixa_de_ontem==0) && ($registro_fechamento_de_caixa==0) && ($reg_mensagem==0) && ($ultimo_departamento_trabalhado=="HAPPY HOUR") or ($reg_mensagem==0) && ($ultimo_departamento_trabalhado<>"") && ($funcao=="GERENTE")){ echo "<input type='submit' name='Submit5' value='FECHAMENTO DE CAIXA'>"; } ?>
        </div>
      </form>
    </div></td>
    <td>&nbsp;</td>
