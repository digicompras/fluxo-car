...
$sql = "SELECT * FROM dependentes where num_carteira_dependente = '$num_carteira_dependente' limit 1";
...
<strong><font color="#0000FF" size="4">Tela de edi&ccedil;&atilde;o do cadastro de dependentes!</font></strong></div>
            <p>
<?
