            ...
            <td width="49%" valign="top"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td colspan="3" bgcolor="#4475AA"><div align="center">
                  <?
$sql = "SELECT * FROM cx_entradas where operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and categoria_conta <> 'Abertura de Caixa' and datecadastro between '$datainicial' and '$datafinal'  group by datecadastro order by codigo desc";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
$reg++;
...
$sql2 = "select sum(valor) as total_do_dia from cx_entradas where operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datecadastro = '$datecadastro' and categoria_conta <> 'Abertura de Caixa'";
...
$sql3 = "SELECT * FROM cx_entradas where operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and categoria_conta <> 'Abertura de Caixa' and datecadastro = '$data_abrir' order by codigo desc";
...
?>
              ...
              <tr>
                <td colspan="3"><div align="center"><strong>Total Geral
                      <?
$sql = "select sum(valor) as total_entradas from cx_entradas where operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and categoria_conta <> 'Abertura de Caixa' and datecadastro between '$datainicial' and '$datafinal'";
            ...
            <td width="50%" valign="top"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td colspan="3" bgcolor="#AA5D5E"><div align="center">
                  <?
$sql = "SELECT * FROM cx_saidas where operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datecadastro between '$datainicial' and '$datafinal'  group by datecadastro order by codigo desc";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
$reg++;
...
$sql2 = "select sum(valor) as total_saidas_do_dia from cx_saidas where operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datecadastro = '$datecadastrosaida'";
$resultado2=mysql_query($sql2, $conexao);
$linha=mysql_fetch_array($resultado2);
...
$sql3 = "SELECT * FROM cx_saidas where operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and categoria_conta <> 'Abertura de Caixa' and datecadastro = '$data_abrir' order by codigo desc";
$res3 = mysql_query($sql3);
while($linha=mysql_fetch_row($res3)) {
...
?>
              ...
              <tr>
                <td colspan="3"><div align="center"><strong>Total Geral
                  <?
$sql = "select sum(valor) as total_saidas from cx_saidas where operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and categoria_conta <> 'Abertura de Caixa' and datecadastro between '$datainicial' and '$datafinal'";
$resultado=mysql_query($sql, $conexao);
$linha=mysql_fetch_array($resultado);
...
$sql = "select sum(valor_a_receber) as total_dos_cartoes from contas_a_receber where operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' and (modopagto <> 'DINHEIRO') and (quitacao <> 'Recebido do Cliente')";
...
$sql2 = "select * from contas_a_receber where modopagto = 'CARTAO' and tipocartao = 'CARTAO DE DEBITO' and operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' group by cartao order by cartao asc";
...
$sql3 = "select sum(valor_a_receber) as totalcartao from contas_a_receber where modopagto = 'CARTAO' and cartao = '$cartao_debito' and tipocartao = 'CARTAO DE DEBITO' and operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' and (quitacao <> 'Recebido do Cliente')";
...
$sql4 = "select * from contas_a_receber where modopagto = 'CARTAO' and tipocartao = 'CARTAO DE CREDITO' and operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' group by cartao order by cartao asc";
...
$sql5 = "select sum(valor_a_receber) as totalcartao from contas_a_receber where modopagto = 'CARTAO' and cartao = '$cartao_credito' and tipocartao = 'CARTAO DE CREDITO' and operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' and (quitacao <> 'Recebido do Cliente')";
...
$sql4 = "select * from contas_a_receber where modopagto = 'CARNE' and operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' group by cartao order by cartao asc";
$res4 = mysql_query($sql4);
while($linha=mysql_fetch_row($res4)) {
...
$sql5 = "select sum(valor_a_receber) as totalcartao from contas_a_receber where modopagto = 'CARNE' and operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' and (quitacao <> 'Recebido do Cliente')";
...
$sql4 = "select * from contas_a_receber where modopagto = 'CHEQUE' and operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' group by cartao order by cartao asc";
$res4 = mysql_query($sql4);
while($linha=mysql_fetch_row($res4)) {
...
$sql5 = "select sum(valor_a_receber) as totalcartao from contas_a_receber where modopagto = 'CHEQUE' and operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' and (quitacao <> 'Recebido do Cliente')";
...
$sql4 = "select * from contas_a_receber where modopagto = 'DEPOSITO' and operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' group by cartao order by cartao asc";
$res4 = mysql_query($sql4);
while($linha=mysql_fetch_row($res4)) {
...
$sql5 = "select sum(valor_a_receber) as totalcartao from contas_a_receber where modopagto = 'DEPOSITO' and operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' and (quitacao <> 'Recebido do Cliente')";
...
$sql4 = "select * from contas_a_receber where modopagto = 'DOC' and operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' group by cartao order by cartao asc";
$res4 = mysql_query($sql4);
while($linha=mysql_fetch_row($res4)) {
...
$sql5 = "select sum(valor_a_receber) as totalcartao from contas_a_receber where modopagto = 'DOC' and operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' and (quitacao <> 'Recebido do Cliente')";
...
$sql4 = "select * from contas_a_receber where modopagto = 'TED' and operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' group by cartao order by cartao asc";
$res4 = mysql_query($sql4);
while($linha=mysql_fetch_row($res4)) {
...
$sql5 = "select sum(valor_a_receber) as totalcartao from contas_a_receber where modopagto = 'TED' and operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' and (quitacao <> 'Recebido do Cliente')";
...
$sql6 = "select * from contas_a_receber where modopagto = 'CARTEIRA' and operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' group by cartao order by cartao asc";
...
$sql7 = "select sum(valor_a_receber) as totalcarteira from contas_a_receber where modopagto = 'CARTEIRA' and operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' and (quitacao <> 'Recebido do Cliente')";
...
$sql = "select sum(quant) as totalembalagens from produtos_em_orcamento where operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and status = 'Finalizado' and datafechamento between '$datainicial' and '$datafinal'";
$resultado=mysql_query($sql, $conexao);
$linha=mysql_fetch_array($resultado);
...
$sql = "select * from produtos_em_orcamento where operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and status = 'Finalizado' and datafechamento between '$datainicial' and '$datafinal' group by nomeproduto";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
$sql2 = "select sum(quant) as totalembalagensporproduto from produtos_em_orcamento where nomeproduto = '$produtovendido' and operador = '$nome_op' and departamento = '$ultimo_departamento_trabalhado' and status = 'Finalizado' and datafechamento between '$datainicial' and '$datafinal'";
$resultado2=mysql_query($sql2, $conexao);
$linha=mysql_fetch_array($resultado2);
...
$saldo_de_fechamento = bcadd($total_caixa_hoje,$total_recebimento_cartoes,2);

$comando = "insert into cx_fechamento(datafechamento,horafechamento,valorfechamento,operador,loja,departamento,valordinheiro_de_fechamento,valorcartao_de_fechamento,valorsaidas_de_fechamento,saldo_de_fechamento)
values('$datefechamento','$horafechamento','$total_caixa_hoje','$nome_op','$ultimo_departamento_trabalhado','$ultimo_departamento_trabalhado','$valor_total_entradas','$total_recebimento_cartoes','$valor_total_saidas','$saldo_de_fechamento')";
