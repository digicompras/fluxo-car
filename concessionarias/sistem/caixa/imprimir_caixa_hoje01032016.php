...
$sql = "select sum(valor_a_receber) as total_dos_cartoes from contas_a_receber where departamento = '$ultimo_departamento_trabalhado' and datacadastro = '$hoje_norteamericano' and (modopagto = 'CARTAO')";
...
$sql2 = "select * from contas_a_receber where modopagto = '$modopagto' and departamento = '$ultimo_departamento_trabalhado' and datacadastro = '$hoje_norteamericano' group by cartao order by cartao asc";
...
$sql3 = "select sum(valor_a_receber) as totalcartao from contas_a_receber where modopagto = '$modopagto' and cartao = '$cartao' and departamento = '$ultimo_departamento_trabalhado' and datacadastro = '$hoje_norteamericano'";
