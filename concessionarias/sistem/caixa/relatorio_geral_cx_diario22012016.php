...
$categoria_conta = "Fechamento de Caixa";
...
values('$datafechamento','$datecadastro','$horacadastro','$estab_pertence_op','$nome_op','$celular_op','$email_op','$estab_pertence_op','$cidade_estab_pertence_op','$tel_estab_pertence_op','$email_estab_pertence_op','$historico','$dia','$mes','$ano','$categoria_conta','$ultimo_departamento_trabalhado')";
...
</span> <span class="style1"><? echo $nome_op; ?></span><span class="style2"> verificando os lan&ccedil;amentos do caixa em <? echo $datafechamento; ?>  <? echo " no departamento $ultimo_departamento_trabalhado"; ?><BR>
...
$sql = "SELECT * FROM cx_entradas where datecadastro = '$datecadastro' and categoria_conta = 'Abertura de Caixa' and departamento = '$ultimo_departamento_trabalhado' order by codigo asc";
...
$sql = "SELECT * FROM cx_entradas where datecadastro = '$datecadastro' and departamento = '$ultimo_departamento_trabalhado' and categoria_conta <> 'Abertura de Caixa' and categoria_conta <> 'Fechamento de Caixa' order by codigo asc";
...
$sql = "select sum(valor) as total_entradas from cx_entradas where datecadastro = '$datecadastro' and departamento = '$ultimo_departamento_trabalhado' and categoria_conta <> 'Abertura de Caixa'";
...
$sql = "SELECT * FROM cx_saidas where datecadastro = '$datecadastro' and departamento = '$ultimo_departamento_trabalhado' order by codigo asc";
...
$sql = "select sum(valor) as total_saidas from cx_saidas where datecadastro = '$datecadastro' and departamento = '$ultimo_departamento_trabalhado'";
...
$sql = "select sum(valor_a_receber) as total_dos_cartoes from contas_a_receber where departamento = '$ultimo_departamento_trabalhado' and datacadastro = '$datecadastro' and (modopagto = 'CARTAO DE DEBITO' or modopagto = 'CARTAO DE CREDITO' or modopagto = 'CARNE')";
...
$sql1 = "select * from orcamentos where modopagto <> 'DINHEIRO' and departamento = '$ultimo_departamento_trabalhado' and dataabertura = '$datecadastro' group by modopagto order by modopagto asc";
...
?>
  <tr>
    <td colspan="2" class="style21"><div align="center"><span class="style2 style2 style4"><strong><font color="#0000FF"><strong><? echo $modopagto; ?></strong></font></strong></span></div>      <div align="center"></div></td>
    </tr>
    <?
  

$sql2 = "select * from contas_a_receber where modopagto = '$modopagto' and departamento = '$ultimo_departamento_trabalhado' and datacadastro = '$datecadastro' group by cartao order by cartao asc";
...
$sql3 = "select sum(valor_a_receber) as totalcartao from contas_a_receber where modopagto = '$modopagto' and cartao = '$cartao' and departamento = '$ultimo_departamento_trabalhado' and datacadastro = '$datecadastro'";
...
?>
  ...
  <tr>
    <td class="style21"><div align="center"><span class="style6"><? echo $cartao; ?>  
</span></div></td>
