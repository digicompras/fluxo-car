...
?>
    ...
    <tr>
      ...
      <td><form action="verifica_mensalidades.php" method="post" name="form2">
...
?>
    ...
    <tr>
      ...
      <td><form action="verifica_mensalidades_por_cpf.php" method="post" name="form2">
        N&ordm; Proposta
  <input type="text" name="cpf" id="cpf">
  <input type="submit" name="Submit3" value="Contas a receber por n&ordm; de CPF">
  <span class="style1">
  <?
