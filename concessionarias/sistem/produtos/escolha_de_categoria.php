...
<strong><font color="#0000FF" size="4">Escolha a categoria que deseja adicionar o novo produto ao banco de dados de sua loja! </font></strong></td>
    ...
    <tr>
      ...
      <td><select name="categoria" id="categoria">
		  <?
      $sql = "select * from categorias_receitas where categoria = 'VENDA DE PRODUTOS' group by categoria order by categoria";
    $result = mysql_query($sql);
    while($x=mysql_fetch_array($result)){
  echo "<option selected>".$x['categoria']."</option>";
    }
		  ?>
        <?
...
?>
      ...
      <td width="20%"><select name="sub_categoria" id="sub_categoria">
...
?>
      ...
      <td width="20%"><select name="classe" id="classe">
        <option ><? echo $classeretorno; ?></option>
...
?>
      ...
      <td colspan="4"><input type="submit" name="Submit" value="Avan&ccedil;ar">      </td>
    </tr>
  </table>
</form>
<p>&nbsp; </p>
