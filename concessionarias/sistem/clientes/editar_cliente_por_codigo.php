...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      <td>Socio do Castelinho?</td>
      <td><select name="socio_castelinho" id="socio_castelinho">
        <option selected><? echo $socio_castelinho; ?></option>
        <option>Sim</option>
    ...
    <tr>
      <td>N&ordm; Carteira Castelinho</td>
      <td><strong><font color="#0000FF">
        <input name="num_carteira_titular" type="text" id="num_carteira_titular" value="<? echo $num_carteira_titular; ?>">
      </font></strong></td>
      <td>N&ordm; Titulo Castelinho</td>
      <td><strong><font color="#0000FF">
        <input name="num_titulo_titular" type="text" id="num_titulo_titular" value="<? echo $num_titulo_titular; ?>">
      </font></strong></td>
    </tr>
    <tr> 
...
?>
    ...
    <tr>
      ...
      <td><textarea name="obs" cols="45" rows="7" id="obs"></textarea></td>

      <td colspan="2" valign="top"><textarea name="obs2" cols="45" rows="7" readonly="readonly" id="obs2"><?  
