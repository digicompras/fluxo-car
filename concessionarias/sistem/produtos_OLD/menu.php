...
echo "*";
    ...
    <td width="17%"><div align="center"><? echo $cod_barras; ?></div></td>
    <td width="27%"><div align="center"><? echo $nome_produto; ?></div></td>
...
echo "R$ $preco";
    ...
    <td width="15%"><div align="center"><? echo $fornecedor; ?></div></td>
    <td width="10%"><div align="center"><? echo $quant_estoque; ?></div></td>
    <td width="11%"><div align="center"><? echo $quant_disponivel; ?></div></td>
  </tr>
  <? } ?>
</table>
<p>&nbsp;</p>
