...
<form name="form1" method="post" action="../clientes/grava_cadcli.php">
...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF">
        <input name="num_carteira_titular" type="text" id="num_carteira_titular">
      </font></strong></td>
      <td>N&ordm; Titulo Castelinho</td>
      <td><strong><font color="#0000FF">
        <input name="num_titulo_titular" type="text" id="num_titulo_titular">
      </font></strong></td>
    </tr>
    <tr> 
