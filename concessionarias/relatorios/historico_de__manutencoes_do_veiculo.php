...
$link_nf = "http://www.fluxocar.com.br/$placa/$data_da_manutencao/$numero_manutencao/$foto";
...
<p>&nbsp;</p>
	...
	<?
$sql = "SELECT * FROM ocorrencias where placa = '$placa' and visualizacao = 'sim' order by `datamanutencao` desc,`codigo` desc";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
<table width="100%" border="0" cellspacing="0">
  <tbody>
    ...
    <tr>
      ...
      <td width="30%" rowspan="11" align="center" valign="top" background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px">
		  <? if($inclui_mais_uma_nf=="sim"){ ?>
		  
		  <form action="historico_de__manutencoes_do_veiculo.php" method="post" enctype="multipart/form-data" name="form1">
        <?
...
?>
    ...
    <tr>
      ...
      <td width="18%" background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px"><? echo $horamanutencao; ?></td>
    ...
    <tr>
      ...
      <td background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px">Tipo de manuten&ccedil;&atilde;o</td>
    ...
    <tr>
      ...
      <td background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px"><? echo "$tipomanutencao"; ?></td>
      <td background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px"><? echo "$placa"; ?></td>
    </tr>
    <tr>
      <td colspan="2" background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px">NF/Doc</td>
    ...
    <tr>
      <td colspan="2" background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px"><?
	...
	echo "<a href='$link_da_nf' target='_blank'>$numero_nf</a>"; 
      ...
      <td background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px">Valor total da manuten&ccedil;&atilde;o</td>
    </tr>
    <tr>
      <td colspan="2" background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px">&nbsp;</td>
      <td background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px">&nbsp;</td>
      <td background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px"><strong><font color="#0000FF"><strong><font color="#0000FF"><strong><font color="#0000FF"><strong><font color="#0000FF"><? echo $valormanutencao; ?></font></strong></font></strong></font></strong></font></strong></td>
    </tr>
	  <?
...
$valor_da_nf = $linha[10];
    ...
    <tr>
	  ...
	  <? } ?>
    <tr>
        <td colspan="4" align="center" background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px"><form action="../sistem/orcamentos/imprime_orcamento_para_cliente.php" method="post" name="form1" target="_blank">
          <strong> 
          <?
...
?>
	...
	?>
          PE&Ccedil;AS UTILIZADAS </strong> - <strong><font color="#0000FF">
            <input name="codigo_orcamento" type="hidden" id="codigo_orcamento" value="<? echo $codigo_orcamento; ?>">
              </font></strong>
      <input type="submit" class='class01' name="submit" id="submit" value="Visualizar Or&ccedil;amento <? echo $codigo_orcamento; ?>">
			<? } ?>
        </form></td>
        <td align="center" valign="top" background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px">&nbsp;</td>
    </tr>
    <tr>
        <td colspan="4" align="center" background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px">&nbsp;</td>
        <td align="center" valign="top" background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px">&nbsp;</td>
    </tr>
	  <?
...
$registros_de_pecas_utilizadas_na_manutencao = mysql_num_rows($res5);
	?>
	  ...
	  <? if(($codigo_orcamento=="") && ($registros_de_pecas_utilizadas_na_manutencao==0) ) {
	...
	if($registros_de_pecas_utilizadas_na_manutencao>=0){
...
$sql4 = "SELECT * FROM produtos_em_orcamento where codigo_orcamento = '$codigo_orcamento'";
$res4 = mysql_query($sql4);
while($linha=mysql_fetch_row($res4)) {
$reg_produtosemorcamento++;

$referencia = $linha[17];

$codigo_interno_da_peca = $linha[17];
$quant_utilizada = $linha[21];
$nome_produto = $linha[18];
