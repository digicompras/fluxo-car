...
$sql = "SELECT * FROM veiculos where fornecedor <> 'WPX LOCACOES LTDA'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
<table width="100%" border="0" cellspacing="0">
  <tbody>
    <tr>
      <th colspan="4" background="../../imagens_sistema/fundocelulas2.png" style="font-size: 16px" scope="col">MANUTENCOES REALIZADAS</th>
    </tr>
    ...
    <tr>
      ...
      <td width="30%" background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      <td background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px"><strong><font color="#0000FF"><strong><font color="#0000FF"><? echo $operador; ?></font></strong></font></strong></td>
      <td background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px"><? echo "<a href='$link_nf' target='_blank'>$nf</a>"; ?></td>
...
$valor_da_nf = $linha[10];
    ...
    <tr>
      <td colspan="4" background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px"><? echo $detalhamento; ?></td>
    </tr>
    <tr>
      <td style="font-size: 16px">&nbsp;</td>
