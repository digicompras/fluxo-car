...
values('$cod_ocorrencia','$nf','$fornecedor','$veiculo','$placa','$chassi','$renavam','$datamanutencao','$link_nf','$valor_da_manutencao')";
...
<table width="100%" border="0" cellspacing="0">
  <tbody>
    ...
    <tr>
      ...
      <td width="30%" rowspan="9" align="center" valign="top" background="../../imagens_sistema/fundocelulas1.png" style="font-size: 16px"><form action="historico_de__manutencoes_do_veiculo.php" method="post" enctype="multipart/form-data" name="form1">
        <?
