...
$sql = "SELECT * FROM contas_a_pagar where quitacao = 'Em Aberto' and vencto between '$data_inicial'and '$data_final' limit 1";
...
?>
          ...
          Listando todas as contas a pagar do periodo:</span> <span class="style1"><? echo "De $dia_inicial-$mes_inicial-$ano_inicial ate $dia_final-$mes_final-$ano_final"; ?></span><span class="style2"><BR><? } ?> </span></div></td>
...
<form name="form2" method="post" action="verifica_mensalidades.php">	
        ...
        <tr>
          <td width="27%"><div align="center"><? echo $fornecedor; ?></div></td>
          <td width="12%"><div align="center"><? echo $num_fatura; ?></div></td>
