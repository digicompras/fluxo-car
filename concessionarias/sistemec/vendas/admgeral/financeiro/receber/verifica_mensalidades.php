...
$sql3 = "SELECT * FROM cx_entradas where num_fatura = '$num_fatura' and num_orcamento = '$num_orcamento' and cod_contas_a_receber = '$cod_contas_a_receber' and num_mensalidade = '$num_mensalidade' and categoria_conta = 'VENDA DE PRODUTOS'";
