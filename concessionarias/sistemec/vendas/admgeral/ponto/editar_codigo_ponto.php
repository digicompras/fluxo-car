...
<form name="form2" method="post" action="grava_editar_codigo_ponto.php">
  ...
  <table width="87%"  border="0">
    ...
    <tr>
      ...
      <input name="date" type="hidden" id="date" value="<? echo $date; ?>"></td>

      <td width="20%"><? echo $nome; ?></td>
      ...
      <td width="8%"><div align="center">
        <select name="atestado_m" id="atestado_m">
          <option selected><? echo $atestado_m; ?></option>
          <option>Sim</option>
