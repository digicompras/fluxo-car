...
Use o formato 00000-000</td>
    ...
    <tr>
      ...
      <td>
        ...
        Fator 
        <input name="fator1" type="text" id="fator1" value="<? echo $fator1; ?>" size="10">
      </div></td><td>&nbsp;</td>
    </tr>
    <tr>
      <td><div align="left">Produto / Servi&ccedil;o </div></td>
      ...
      Fator 
      <input name="fator2" type="text" id="fator2" value="<? echo $fator2; ?>" size="10">
        </div></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      ...
      Fator 
      <input name="fator3" type="text" id="fator3" value="<? echo $fator3; ?>" size="10">
        </div></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
...
$cel_operador_alterou = $linha[19];
$email_operador_alterou = $linha[20];
$estabelecimento_alterando = $linha[44];
$cidade_estabelecimento_alterando = $linha[45];
$tel_estabelecimento_alterando = $linha[46];
$email_estabelecimento_alterando = $linha[47];
...
?>
  <table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      <td width="18%"><strong><font color="#0000FF"> </font>Estabelecimento:</strong> <br>
          <strong><font color="#0000FF"><? echo $estabelecimento_alterando; ?> </font></strong><strong><font color="#0000FF"> </font></strong></td>
      <td width="26%"><strong><font color="#000000">Tel do estabelecimento: </font><font color="#0000FF"><br>
              <? echo $tel_estabelecimento_alterando; ?> </font></strong></td>
      <td><strong><font color="#000000">E-Mail do estabelecimento: </font><font color="#0000FF"><br>
              <? echo $email_estabelecimento_alterando; ?> </font><font color="#0000FF"> </font></strong></td>
      <td><strong>Cidade: <br>
            <font color="#0000FF"><? echo $cidade_estabelecimento_alterando; ?> </font></strong></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
