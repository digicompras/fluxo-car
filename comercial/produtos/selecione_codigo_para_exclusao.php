...
<p class="style2">Selecione o c&oacute;digo do produto a ser excluido!</p>
...
<form action="excluir_produto.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="100%"  border="0">
    <tr>
      <td width="35%">Selecione o c&oacute;digo. do produto a ser excluido <br></td>
...
$sql = "select * from produtos order by bco_operacao";
...
<span class="style1">Banco de Operação:</span> <? printf("$linha[2]<br>"); ?>
