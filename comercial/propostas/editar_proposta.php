...
?>
    ...
    <td width="28%"><form name="form1" method="post" action="lista_de_propostas.php">
      <?
$usuario = $_SESSION['usuario'];
$senha = $_SESSION['senha'];
?>
      <input name="cpf" type="hidden" id="cpf3" value="<? echo $cpf; ?>">
      <input type="submit" name="Submit3" value="Voltar para lista de propostas">
    </form></td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      ...
      <td>N&ordm; Contrato Banco </td>
      <td><input name="num_contrato_banco" type="text" id="num_contrato_banco" value="<? echo $num_contrato_banco; ?>"></td>
    </tr>
    <tr> 
      <td>Operador</td>
