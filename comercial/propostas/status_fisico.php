...
% </font><font color="#0000FF" size="4"><strong>
    ...
    <tr>
      <td colspan="2"><strong><font color="#0000FF">
        ...
        <input name="hora_alteracao_status_fisico" type="hidden" id="hora_alteracao_status_fisico" value="<? echo date('H:i:s'); ?>">
...
$senha = $_SESSION['senha'];
?>
        <input type="submit" name="Submit" value="Confirmar Recebimento do F&iacute;sico"> 
