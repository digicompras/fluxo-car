...
--
-- Servidor: localhost
-- Tempo de Geração: Mar 01, 2010 as 10:54 AM
...
--
-- Estrutura da tabela `propostas_excluidas`
--

CREATE TABLE IF NOT EXISTS `propostas_excluidas` (
  ...
  `obs2` text NOT NULL,
  `status_fisico` varchar(50) NOT NULL,
  PRIMARY KEY  (`codigo`)
