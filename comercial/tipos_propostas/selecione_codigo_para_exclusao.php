...
<p class="style2">Exclus&atilde;o de Tipo de benef&iacute;cio</p>
...
<form action="excluir.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="100%"  border="0">
    <tr>
      <td width="35%">Selecione o c&oacute;digo. do tipo do benef&iacute;cio a ser exclu&iacute;do<br></td>
      <td width="25%"><strong>
