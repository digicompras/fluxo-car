...
<table width="100%" border="0" cellspacing="4">
    <tr> 
      ...
      <td>        <strong><font color="#0000FF"><? echo "Correspondente"; ?>
        <input name="tipo_op" type="hidden" id="tipo_op" value="<? echo "Correspondente"; ?>">
      </font></strong></td><td>Data Cadastro </td>
...
Use o formato 00000-000</td>
    ...
    <tr>
      <td><font color="#FFFFFF">Comiss&atilde;o</font></td>
      <td><input name="comissao" type="hidden" id="comissao" value=""></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
