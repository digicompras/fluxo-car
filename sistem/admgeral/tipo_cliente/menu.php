...
?>
    ...
    <tr>
      ...
      <td width="77%"><strong><font color="#0000FF" size="4">O que deseja fazer com os Perfis dos clientes?</font></strong></td>
...
?>
        ...
        <input type="submit" name="Submit222" value="Voltar ao menu CLIENTES">
