...
?>
    ...
    <tr>
      <td><div align="center"></div></td> 
      <td><form action="entrada_xml/entrada_xml/entrada_xml_det.php" method="post" enctype="multipart/form-data" name="form4" target="_blank">
        <span class="style1">
        <?
$usuario = $_SESSION['usuario'];
$senha = $_SESSION['senha'];
?>
        ...
        <input type="file" name="arquivo_xml" id="arquivo_xml">
