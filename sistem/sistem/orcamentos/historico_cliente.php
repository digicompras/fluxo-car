...
<table width="100%" border="0" cellspacing="4">
  <tr>
    ...
    <td><form name="form1" method="post" action="selecione_cliente_para_abrir_orcamento.php">
      <input class='class01' type="submit" name="Submit" value="Voltar a sele&ccedil;&atilde;o de cliente">
      <span class="style1">
      <?
$usuario = $_SESSION['usuario'];
$senha = $_SESSION['senha'];
...
<input class='class01' type="submit" name="button3" id="button3" value="Abrir Or&ccedil;amento">
      </form></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      <td colspan="3"><table width="100%" border="0">
        <tr>
          <td colspan="8" bgcolor="#999999"><div align="center"><strong>OR&Ccedil;AMENTOS</strong></div></td>
        </tr>
        <tr>
...
?>
              ...
              <? if($status=="Finalizado"){ echo "<input class='class01' type='submit' name='button2' id='button2' value='Imprimir'>"; } ?>
              </form>
          </div></td>
          <td><div align="center">
...
?>
              ...
              <input name="codigo_cliente" type="hidden" id="codigo_cliente" value="<? echo $codigo_cliente; ?>">
              <input name="codigo_orcamento" type="hidden" id="codigo_orcamento" value="<? echo $codigo_orcamento; ?>">
              <? if($status=="Aberto"){ echo "<input class='class01' type='submit' name='button3' id='button3' value='Editar'>"; } ?>
            </form>
          </div></td>
        </tr>
<?
