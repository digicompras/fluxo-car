...
$codigo_orcamento = $_GET['codigo_orcamento'];
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
        <tr>
          <td><div align="center"><strong><font size="2" class="style3"><? echo $razaosocial; ?><br>
            ...
            Site: <? echo $site; ?> E-Mail: <? echo $email_empresa; ?><br>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr>
    <td width="76%"><div align="center" class="style5"><? echo "$condicao"; //$condicao; ?> <strong>N&ordm;</strong> <strong><? echo $codigo_orcamento; ?></strong> Coprrespondente ao bloco N&ordm; <strong><? echo $num_orcamento_bloco; ?></strong></div></td>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="4">
      <tr>
        ...
        <td width="13%"><span class="style3"><strong><font color="#0000FF"><strong><? echo $telefone_cliente; ?></strong></font></strong></span></td>
        <td width="8%"><span class="style3"><strong>Celular:</strong></span></td>
        <td width="18%"><span class="style3"><strong><font color="#0000FF"><strong><? echo $celular_cliente; ?></strong></font></strong></span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="11%"><strong>Complemento:</strong></td>
...
<table width="100%"  border="1">
  <tr bgcolor="#ffffff">
    ...
    <td width="16%" class="style3"><div align="center"><span class="style3">Especie</span></div></td>
...
?>
  <tr>
    ...
    <td class="style3"><div align="center"><span class="style3"><? echo $especie_adquirida;?></span></div></td>
...
<form name="form1" method="post" action="grava_orcamento.php">
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
    <tr>
      <td width="76%"><div align="center" class="style5"><? echo "$condicao"; //$condicao; ?> <strong>N&ordm; <? echo $codigo_orcamento; ?></strong> Coprrespondente ao bloco N&ordm; <strong><? echo $num_orcamento_bloco; ?></strong></div></td>
      <td width="24%"><div align="center"><span class="style5">Total
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="4">
        <tr>
          ...
          <td width="14%"><span class="style3"><strong><font color="#0000FF"><strong><? echo $telefone_cliente; ?></strong></font></strong></span></td>
          <td width="6%"><span class="style3"><strong>Celular:</strong></span></td>
...
?>
    <tr>
      <td><div align="center" class="style3"><span class="style3"><? echo $codigoproduto;?></span></div></td>
      <td class="style3"><div align="center"><span class="style3"><? echo $nomeproduto;?></span></div></td>
      <td class="style3"><div align="center"><? echo $especie_adquirida;?></div></td>
