...
<?
if($status_filtro==""){			
$sql = "SELECT * FROM veiculos where cnpj_concessionaria = '$cnpj'  order by codigo desc";
}
else{
$sql = "SELECT * FROM veiculos where cnpj_concessionaria = '$cnpj' and status = '$status_filtro' order by codigo desc";
}
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
