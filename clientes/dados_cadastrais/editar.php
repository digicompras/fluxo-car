...
<form name="form1" method="post" action="grava_editar.php">
  <table width="100%" border="0" cellspacing="4">
    ...
    $sql = "select * from operadores where estab_pertence = 'Digicompras' order by nome asc";
...
<form name="form1" method="post" action="calcula_pedido.php">
  <table width="100%" border="0" cellspacing="4">
    <tr>
      <td colspan="2"><strong><font color="#FF0000">Cadastro sendo atualmente alterado por</font></strong></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
