...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      <td>Empresa Conv. </td>
      <td><strong><font color="#0000FF"><? echo $estab_pertence_op; ?>
        <input name="estab_pertence" type="hidden" id="datacadastro" value="<? echo $estab_pertence_op; ?>">
      </font></strong></td>
      <td>Cidade</td>
      <td><strong><font color="#0000FF"><? echo $cidade_estab_pertence_op; ?>
            <input name="cidade_estab_pertence" type="hidden" id="estab_pertence" value="<? echo $cidade_estab_pertence_op; ?>">
      </font></strong></td>
    </tr>
    <tr>
      <td>Telefone</td>
      <td><strong><font color="#0000FF"><? echo $tel_estab_pertence_op; ?>
            <input name="tel_estab_pertence" type="hidden" id="tel_estab_pertence" value="<? echo $tel_estab_pertence_op; ?>">
      </font></strong></td>
      <td>E_Mail</td>
      <td><strong><font color="#0000FF"><? echo $email_estab_pertence_op; ?>
            <input name="email_estab_pertence" type="hidden" id="estab_pertence3" value="<? echo $email_estab_pertence_op; ?>">
      </font></strong></td>
    </tr>
    <tr> 
      <td>Nome</td>
