...
?>
      ...
      <td width="33%"><p><strong><font color="#0000FF">
        <input name="valor_credito" type="text" id="valor_credito3" value="<? echo $valor_credito; ?>">
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF">
        <input name="valor_liberado" type="text" id="valor_liberado2" value="<? echo $valor_liberado; ?>">
      </font></strong></td>
      <td>Recurso Utilizado </td>
      <td><strong><font color="#0000FF">
        <select name="tipo_capital" id="tipo_capital">
          <option selected><? echo $tipo_capital; ?></option>
...
?>
    ...
    <tr>
      ...
      <td><input name="percentual_op" type="text" id="percentual_op" value="<? echo $percentual_op; ?>">
        <font color="#0000FF"><strong>%</strong></font></td>
      <td>Comiss&atilde;o do operador</td>
      <td><input name="comissao_op" type="text" id="percentual_op3" value="<? echo bcmul($valor_credito, $percentual_op, 2); ?>"></td>
    </tr>
    <tr>
