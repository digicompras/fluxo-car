...
<form name="form1" method="post" action="grava_editar_veiculo.php">
...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      ...
      <td>        <input name="veiculo" type="text" id="veiculo" value="<? echo $veiculo; ?>"></td>
      <td>Placas</td>
      <td>        <input name="placa" type="text" id="placa" value="<? echo $placa; ?>"></td>
    </tr>
    <tr>
      <td>Ano</td>
      <td>        <input name="ano" type="text" id="ano" value="<? echo $ano; ?>"></td>
      <td>Modelo</td>
      <td>        <input name="modelo" type="text" id="modelo" value="<? echo $modelo; ?>"></td>
    </tr>
    <tr>
      <td>Chassi</td>
      <td>        <input name="chassi" type="text" id="chassi" value="<? echo $chassi; ?>"></td>
      <td>Renavam</td>
      <td>        <input name="renavam" type="text" id="renavam" value="<? echo $renavam; ?>"></td>
    </tr>
    <tr>
      <td>Observa&ccedil;&otilde;es</td>
      <td colspan="3">        <input name="obs_veiculo" type="text" id="obs_veiculo" value="<? echo $obs_veiculo; ?>" size="80"></td>
    </tr>
    <tr>
      <td>In&iacute;cio Contrato </td>
      <td><strong><font color="#0000FF">
        <select name="dia_inicio_contrato" id="dia_inicio_contrato">
          <option selected><? echo $dia_inicio_contrato; ?></option>
          <option>01</option>
          <option>02</option>
          <option>03</option>
          <option>04</option>
        ...
        <select name="mes_inicio_contrato" id="mes_inicio_contrato">
          <option selected><? echo $mes_inicio_contrato; ?></option>
          <option>01</option>
          <option>02</option>
          <option>03</option>
          <option>04</option>
        ...
        <select name="ano_inicio_contrato" id="ano_inicio_contrato">
          <option selected><? echo $ano_inicio_contrato; ?></option>
          <option>
          <?
...
echo "$ano_atual";
      ...
      <td><strong><font color="#0000FF">
        <select name="dia_termino_contrato" id="select4">
          <option selected><? echo $dia_termino_contrato; ?></option>
          <option>01</option>
          <option>02</option>
          <option>03</option>
          <option>04</option>
        ...
        <select name="mes_termino_contrato" id="select5">
          <option selected><? echo $mes_termino_contrato; ?></option>
          <option>01</option>
          <option>02</option>
          <option>03</option>
          <option>04</option>
        ...
        <select name="ano_termino_contrato" id="ano_termino_contrato">
          <option selected><? echo $ano_termino_contrato; ?></option>
          <option>
          <?
