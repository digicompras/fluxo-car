...
<table width="80%" border="0">
  <tbody>
    <tr>
      <th width="23%" scope="col"><form name="form1" method="post" action="menu.php">
        <?
...
<table width="80%" border="0" align="center">
  <tbody>
    <tr>
      ...
      <th width="43%" align="center" scope="col"><?php
	
	$dados = "www.digicompras.com.br/fluxocar/buscainformacoes.php?placa=$placa";
		...
		?>
        <br>
      <div style="float: left; border: 1px solid #000;"> <img src="<?php echo $aux; ?>" /> </div></th>
