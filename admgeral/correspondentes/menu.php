...
$senha = $_SESSION['senha'];
?>
        <input type="submit" name="Submit" value="Relat&oacute;rio por correspondente">
      </form></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
...
$senha = $_SESSION['senha'];
?>
        <input type="submit" name="Submit2" value="Cadastrar Correspondente">
      </form></td>
    </tr>
    <tr>
      <td><div align="center"></div></td> 
...
$senha = $_SESSION['senha'];
?>
        <input type="submit" name="Submit3" value="Editar Correspondente">
      </form></td>
    </tr>
    <tr>
      <td><div align="center"></div></td> 
...
$senha = $_SESSION['senha'];
?>
        <input type="submit" name="Submit4" value="Excluir Correspondente">
      </form></td>
    </tr>
  </table>
<p>&nbsp; </p>
