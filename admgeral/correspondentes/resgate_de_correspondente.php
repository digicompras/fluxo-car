...
<html>
<head>
<title>RESGATE DE CORRESPONDENTE</title>
...
$sql = "SELECT * FROM correspondentes_excluidos where nome = '$nome'";
$res = mysql_query($sql);
$reg = 0;
echo "<tr>";
while($linha=mysql_fetch_row($res)) {
...
$senha = $_SESSION['senha'];
?>
        <input type="submit" name="Submit" value="Resgatar Correspondente"> 
