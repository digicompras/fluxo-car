...
$sql = "SELECT * FROM contas_a_receber where num_proposta = '$num_proposta' and quitacao = 'Recebido'";
...
$sql = "SELECT * FROM contas_a_receber where num_proposta = '$num_proposta' and quitacao = 'Recebido' order by num_mensalidade asc";
