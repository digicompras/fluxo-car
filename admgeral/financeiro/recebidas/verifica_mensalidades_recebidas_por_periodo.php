...
$sql = "SELECT * FROM contas_a_receber where quitacao = 'Recebido' and vencto between '$data_inicial'and '$data_final' limit 1";
...
?>
          ...
          Listando todas as mensalidades recebidas do periodo:</span> <span class="style1"><? echo "De $dia_inicial-$mes_inicial-$ano_inicial ate $dia_final-$mes_final-$ano_final"; ?></span><span class="style2"><BR><? } ?> </span></div></td>
...
<table width="100%"  border="0">
        ...
        <tr bgcolor="#<? echo $cor ?>">
          ...
          <td width="13%"><div align="center">Valor Mensalidade</div></td>
...
$sql = "SELECT * FROM contas_a_receber where quitacao = 'Recebido' and vencto between '$data_inicial'and '$data_final'";
...
$sql2 = "SELECT * FROM cx_entradas where num_proposta = '$num_proposta' and cod_contas_a_receber = '$codigo' and num_mensalidade = '$num_mensalidade' order by num_mensalidade asc";
...
?>
        ...
        <tr>
          <td width="27%"><div align="center"><? echo $nome; ?></div></td>
          <td width="12%"><div align="center"><? echo $num_proposta; ?></div></td>
