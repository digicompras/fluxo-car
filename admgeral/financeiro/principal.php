...
<table width="100%"  border="0">
  ...
  <tr>
    ...
    <td width="20%"><form name="form2" method="post" action="contas_a_pagar/menu.php">
      <?
	...
	?>
      <input type="submit" name="Submit6" value="Contas a Pagar">
    </form></td>

    <td width="20%"><form name="form2" method="post" action="receber/menu.php">
      <?
	...
	?>
      <input type="submit" name="Submit5" value="Contas a Receber">
    </form></td>
	...
	?>
      ...
      <input type="hidden" name="dia_inicial" id="dia_inicial">
      <input type="hidden" name="mes_inicial" id="mes_inicial">
      <input type="hidden" name="ano_inicial" id="ano_inicial">
      <input type="hidden" name="dia_final" id="dia_final">
      <input type="hidden" name="mes_final" id="mes_final">
      <input type="hidden" name="ano_final" id="ano_final">
      <input type="submit" name="Submit" value="Caixa">
    </form></td>

    <td width="20%"><form name="form2" method="post" action="banco/menu.php">
      <?
	...
	?>
      <input type="submit" name="Submit4" value="Banco">
    </form></td>
  ...
  <tr>
    ...
    <td><form name="form2" method="post" action="pagas/menu.php">
      <?
	...
	?>
      <input type="submit" name="button" id="button" value="Contas Pagas">
    </form></td>

    <td><form name="form2" method="post" action="recebidas/menu.php">
      <?
	...
	?>
      <input type="submit" name="Submit8" value="Contas a Recebidas">
    </form></td>
