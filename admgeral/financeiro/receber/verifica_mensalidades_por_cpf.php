...
$sql = "SELECT * FROM contas_a_receber where num_fatura = '$num_fatura' limit 1";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
$sql = "SELECT * FROM contas_a_receber where cpf = '$cpf' and quitacao = 'Em Aberto' limit 1";
...
?>
          ...
          Listando todas as mensalidades do CPF:</span> <span class="style1"><? echo $cpf; ?></span><span class="style2"><BR>
...
$sql = "SELECT * FROM contas_a_receber where cpf = '$cpf' and quitacao = 'Em Aberto' order by num_mensalidade asc";
...
<form name="form2" method="post" action="verifica_mensalidades.php">
        ...
        <tr>
          ...
          <td width="7%"><div align="center"><? echo $vencto; ?></div></td>
