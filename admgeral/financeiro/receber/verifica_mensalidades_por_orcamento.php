...
$sql = "SELECT * FROM contas_a_receber where codigo_orcamento = '$codigo_orcamento' and quitacao = 'Em Aberto' limit 1";
...
$sql = "SELECT * FROM contas_a_receber where codigo_orcamento = '$codigo_orcamento' and quitacao = 'Em Aberto' order by num_mensalidade asc";
