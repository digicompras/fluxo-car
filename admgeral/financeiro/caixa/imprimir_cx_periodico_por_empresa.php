...
</span> <span class="style1"><? echo $nome_op; ?></span><span class="style2"> verificando os lan&ccedil;amentos do caixa da loja <? echo $nfantasia; ?> em <? echo "$datainicial ate $datafinal"; ?><BR>
...
$sql = "SELECT * FROM cx_entradas where nfantasia = '$nfantasia' and datecadastro between '$datainicial' and '$datafinal' order by codigo asc";
...
?>
              ...
              <tr>
                ...
                <td width="27%"><div align="center"><span class="style11"><? echo $nome_cli; ?></span></div></td>
                <td width="27%">
...
$sql = "select sum(valor) as total_entradas from cx_entradas where nfantasia = '$nfantasia' and datecadastro between '$datainicial' and '$datafinal'";
...
$sql = "SELECT * FROM cx_saidas where nfantasia = '$nfantasia' and datecadastro between '$datainicial' and '$datafinal' order by codigo asc";
...
$sql = "select sum(valor) as total_saidas from cx_saidas where nfantasia = '$nfantasia' and datecadastro between '$datainicial' and '$datafinal'";
