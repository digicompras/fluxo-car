...
?>
  ...
  <table width="100%"  border="0">
    ...
    <tr>
      ...
      <td width="14%"><form name="form1" method="post" action="menu.php">
...
?>
      ...
      <td width="22%"><form action="imprimir_caixa_hoje.php" method="post" name="form1" target="_blank">
...
$sql = "select sum(valor_a_receber) as total_dos_cartoes from contas_a_receber where datacadastro = '$hoje_norteamericano' and (modopagto = 'CARTAO DE DEBITO' or modopagto = 'CARTAO DE CREDITO' or modopagto = 'CARNE')";
...
$sql1 = "select * from orcamentos where modopagto <> 'DINHEIRO' and dataabertura = '$hoje_norteamericano' group by modopagto order by modopagto asc";
...
$sql2 = "select * from contas_a_receber where modopagto = '$modopagto' and datacadastro = '$hoje_norteamericano' group by cartao order by cartao asc";
...
$sql3 = "select sum(valor_a_receber) as totalcartao from contas_a_receber where modopagto = '$modopagto' and cartao = '$cartao' and datacadastro = '$hoje_norteamericano'";
