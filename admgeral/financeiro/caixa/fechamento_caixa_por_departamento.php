...
$ultimo_departamento_trabalhado = $_POST['departamento'];
...
$sql = "SELECT * FROM cx_entradas where datecadastro between '$datainicial' and '$datafinal' and categoria_conta = 'Abertura de Caixa' and departamento = '$ultimo_departamento_trabalhado'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
$reg++;
...
$sql = "SELECT * FROM cx_entradas where datecadastro between '$datainicial' and '$datafinal' and operador = '$nome' and departamento = '$ultimo_departamento_trabalhado' and categoria_conta <> 'Abertura de Caixa' order by codigo asc";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
$reg++;
...
?>
              ...
              <tr>
                <td colspan="5"><div align="center"><strong> Total
                          <?
$sql = "select sum(valor) as total_entradas from cx_entradas where datecadastro between '$datainicial' and '$datafinal' and departamento = '$ultimo_departamento_trabalhado' and categoria_conta <> 'Abertura de Caixa'";
...
$sql = "SELECT * FROM cx_saidas where datecadastro between '$datainicial' and '$datafinal' and departamento = '$ultimo_departamento_trabalhado' order by codigo asc";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
$reg++;
...
?>
              ...
              <tr>
                <td colspan="6"><div align="center"><strong> Total
                          <?
$sql = "select sum(valor) as total_saidas from cx_saidas where datecadastro between '$datainicial' and '$datafinal' and departamento = '$ultimo_departamento_trabalhado'";
$resultado=mysql_query($sql, $conexao);
$linha=mysql_fetch_array($resultado);
...
$sql = "select sum(valor_a_receber) as total_dos_cartoes from contas_a_receber where operador = '$nome' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' and (modopagto <> 'DINHEIRO') and (quitacao <> 'Recebido do Cliente')";
...
$sql2 = "select * from contas_a_receber where modopagto = 'CARTAO' and tipocartao = 'CARTAO DE DEBITO' and operador = '$nome' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' group by cartao order by cartao asc";
...
$sql3 = "select sum(valor_a_receber) as totalcartao from contas_a_receber where modopagto = 'CARTAO' and cartao = '$cartao_debito' and tipocartao = 'CARTAO DE DEBITO' and operador = '$nome' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' and (quitacao <> 'Recebido do Cliente')";
...
$sql4 = "select * from contas_a_receber where modopagto = 'CARTAO' and tipocartao = 'CARTAO DE CREDITO' and operador = '$nome' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' group by cartao order by cartao asc";
...
$sql5 = "select sum(valor_a_receber) as totalcartao from contas_a_receber where modopagto = 'CARTAO' and cartao = '$cartao_credito' and tipocartao = 'CARTAO DE CREDITO' and operador = '$nome' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' and (quitacao <> 'Recebido do Cliente')";
...
$sql4 = "select * from contas_a_receber where modopagto = 'CARNE' and operador = '$nome' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' group by cartao order by cartao asc";
$res4 = mysql_query($sql4);
while($linha=mysql_fetch_row($res4)) {
...
$sql5 = "select sum(valor_a_receber) as totalcartao from contas_a_receber where modopagto = 'CARNE' and operador = '$nome' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' and (quitacao <> 'Recebido do Cliente')";
...
$sql4 = "select * from contas_a_receber where modopagto = 'CHEQUE' and operador = '$nome' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' group by cartao order by cartao asc";
$res4 = mysql_query($sql4);
while($linha=mysql_fetch_row($res4)) {
...
$sql5 = "select sum(valor_a_receber) as totalcartao from contas_a_receber where modopagto = 'CHEQUE' and operador = '$nome' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' and (quitacao <> 'Recebido do Cliente')";
...
$sql4 = "select * from contas_a_receber where modopagto = 'DEPOSITO' and operador = '$nome' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' group by cartao order by cartao asc";
$res4 = mysql_query($sql4);
while($linha=mysql_fetch_row($res4)) {
...
$sql5 = "select sum(valor_a_receber) as totalcartao from contas_a_receber where modopagto = 'DEPOSITO' and operador = '$nome' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' and (quitacao <> 'Recebido do Cliente')";
...
$sql4 = "select * from contas_a_receber where modopagto = 'DOC' and operador = '$nome' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' group by cartao order by cartao asc";
$res4 = mysql_query($sql4);
while($linha=mysql_fetch_row($res4)) {
...
$sql5 = "select sum(valor_a_receber) as totalcartao from contas_a_receber where modopagto = 'DOC' and operador = '$nome' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' and (quitacao <> 'Recebido do Cliente')";
...
$sql4 = "select * from contas_a_receber where modopagto = 'TED' and operador = '$nome' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' group by cartao order by cartao asc";
$res4 = mysql_query($sql4);
while($linha=mysql_fetch_row($res4)) {
...
$sql5 = "select sum(valor_a_receber) as totalcartao from contas_a_receber where modopagto = 'TED' and operador = '$nome' and departamento = '$ultimo_departamento_trabalhado' and datacadastro between '$datainicial' and '$datafinal' and (quitacao <> 'Recebido do Cliente')";
