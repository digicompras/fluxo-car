...
$sub_valor_a_pagar = $_POST['valor_a_pagar'];
$valor_a_pagar = bcadd($valor_a_pagar,$juros,2);
...
$comando = "insert into bco_saidas(valor,dia,mes,ano,datacadastro,horacadastro,nfantasia,historico,categoria_conta,datecadastro,fornecedor,cpf,operador,cel_operador,email_operador,estabelecimento,cidade_estabelecimento,tel_estabelecimento,email_estabelecimento,num_fatura,cod_contas_a_pagar,num_mensalidade,codigo_orcamento,nome,num_cheque,banco,agencia,contacorrente,tipoconta,departamento) 



values('$valor_a_pagar','$dia','$mes','$ano','$datacadastro','$horacadastro','$estabelecimento','Fatura $num_fatura, Orcamento $num_orcamento - Pagto de parcela $num_mensalidade de $quantparc - CPF $cpf ch $num_cheque','$categoria_conta','$datecadastro','$fornecedor','$cpf','$nome_op','$celular_op','$email_op','$estab_pertence_op','$cidade_estabelecimento_alterou','$tel_estabelecimento_alterou','$email_estabelecimento_alterou','$num_fatura','$cod_contas_a_pagar','$num_mensalidade','$codigo_orcamento','$nfantasia','$num_cheque','$banco','$agencia','$contacorrente','$tipoconta','$departamento')";
...
?>
        ...
        <input type="submit" name="Submit" value="Baixar"></td>
    </tr>
  </form>
  <?
