...
$estab_alterando = $linha[44];

$cidade_estab_alterando = $linha[45];

$tel_estab_alterando = $linha[46];

$email_estab_alterando = $linha[47];
...
<form name="form1" method="post" action="grava_editar_estabelecimento.php">
  ...
  <table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      ...
      <td colspan="3"><strong><font color="#0000FF" size="4">Tela de altera&ccedil;&atilde;o do cadastro de concession&aacute;ria!. </font></strong></td>
...
?>
    ...
    <tr>
      ...
      <td width="36%"> <font color="#0000FF">
        ...
        <input name="nfantasia" type="text" id="nfantasia" value="<? echo $nfantasia; ?>">

        <? ////echo $nfantasia; ?> </font></td>
...
?>
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF">Classificacao
      ...
      <td><select name="valor" id="valor">
        ...
        <option selected><? echo $valor; ?></option>

        <option>235.00</option>

        <option>117.50</option>
...
?>
          ...
          <input type="submit" name="Submit" value="Alterar dados da Concession&aacute;ria"><input name="dataalteracao" type="hidden" id="dataalteracao" value="<? echo date('d-m-Y'); ?>">
        ...
        <input name="cel_operador_alterou" type="hidden" id="cel_operador_alterou" value="<? echo $cel_op; ?>">

        <input name="email_operador_alterou" type="hidden" id="email_operador_alterou" value="<? echo $email_op; ?>">

        <input name="estabelecimento_alterou" type="hidden" id="estabelecimento_alterou" value="<? echo $estab_alterando; ?>">

        <input name="cidade_estabelecimento_alterou" type="hidden" id="cidade_estabelecimento_alterou" value="<? echo $cidade_estab_alterando; ?>">

        <input name="tel_estabelecimento_alterou" type="hidden" id="tel_estabelecimento_alterou" value="<? echo $tel_estab_alterando; ?>">

        <input name="email_estabelecimento_alterou" type="hidden" id="email_estabelecimento_alterou" value="<? echo $email_estab_alterando; ?>">
...
?>
    ...
    <tr>
      ...
      <td width="20%"><strong>Celular:<font color="#0000FF"><br>
              ...
              <? echo $cel_op; ?> </font><font color="#0000FF"> </font></strong></td>
    ...
    <tr>
      ...
      <td width="18%"><strong><font color="#0000FF"> </font>Estabelecimento:</strong> <br>
          ...
          <strong><font color="#0000FF"><? echo $estab_alterando; ?> </font></strong><strong><font color="#0000FF"> </font></strong></td>

      <td width="26%"><strong><font color="#000000">Tel do estabelecimento: </font><font color="#0000FF"><br>

              <? echo $tel_estab_alterando; ?> </font></strong></td>

      <td><strong><font color="#000000">E-Mail do estabelecimento: </font><font color="#0000FF"><br>

              <? echo $email_estab_alterando; ?> </font><font color="#0000FF"> </font></strong></td>

      <td><strong>Cidade: <br>

            <font color="#0000FF"><? echo $cidade_estab_alterando; ?> </font></strong></td>
