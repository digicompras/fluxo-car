...
<html>
<head>
<title>Altera&ccedil;&atilde;o de cart&atilde;o de ponto</title>
...
<form name="form2" method="post" action="grava_editar_codigo_ponto.php">
  <table width="80%"  border="0">
    ...
    <tr>
      <td width="6%"><input name="codigo" type="hidden" id="codigo" value="<? echo $codigo; ?>"></td>
      <td width="24%"><? echo $nome; ?></td>
      <td width="9%"><? echo $data; ?></td>
      <td width="14%"><input name="ent_m" type="text" id="ent_m" value="<? echo $ent_m; ?>" size="10" maxlength="10"></td>
      <td width="15%"><input name="sai_m" type="text" id="sai_m" value="<? echo $sai_m; ?>" size="10" maxlength="10"></td>
    ...
    <tr>
      ...
      <td colspan="5"><input name="justificativa" type="text" id="justificativa" value="<? echo $justificativa; ?>" size="50" maxlength="50">
      <input type="submit" name="Submit2" value="Atualizar"></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
