...
$sql = "SELECT * FROM clientes where codigo2 = '$codigo2'";
$res = mysql_query($sql);
...
?>
  ...
  <table width="100%" border="0" cellspacing="4">
    ...
    <tr> 
      <td colspan="2"><strong><font color="#0000FF">C&oacute;digo que est&aacute; sendo editado: <? echo $codigo2; ?>        <input name="codigo2" type="hidden" id="codigo2" value="<? echo $codigo2; ?>">
...
?>
    ...
    <tr> 
      ...
      <td><input name="usuario" type="text" id="usuario" value="<? echo $linha[36]; ?>" size="50" maxlength="50"> 
        <font color="#0000FF">*</font></td>
