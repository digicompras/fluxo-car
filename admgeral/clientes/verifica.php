...
-->
  ...
  <span class="style1"><? echo $nome; ?></span><? echo " já está cadastrado no sistema!<br><br>Codigo do Cliente: $codigo <br><br> Clique em PREENCHER PROPOSTA!";
...
echo "Cliente NÃO cadastrado na base da dados do sistema!<br><br> Clique em CADASTRAR CLIENTE!";
...
echo "<select name='empresaconveniada' id='empresaconveniada'>
...
?>
    ...
    <td width="40%">
		...
		if($reg==1){
			?>
		<form action="editar_cliente.php" method="post" name="form2">
