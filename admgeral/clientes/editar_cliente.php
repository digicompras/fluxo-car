...
<form name="form1" method="post" action="grava_editar_cliente.php">
  <table width="100%" border="0" cellspacing="4">
    ...
    <tr> 
      ...
      <td><select name="empresaconveniada" id="estado">
...
?>
    ...
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>Comanda Utilizada</td>
      <td><strong><font color="#0000FF">
        <input name="comandadofuncionario" type="hidden" id="comandadofuncionario" value="<? echo $comandadofuncionario; ?>"><? echo "$comandadofuncionario"; ?>
      </font></strong></td>
    </tr>
    <tr> 
