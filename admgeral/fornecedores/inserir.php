...
?>
    ...
    <tr> 
      ...
      <td width="31%"><input name="razaosocial" type="text" id="razaosocial" size="50" maxlength="50"></td>

      <td width="20%">Nome Fantasia </td>

      <td width="35%">        <font color="#0000FF">
...
?>
    ...
    <tr>
      ...
      <td><input name="email_representante" type="text" id="email_representante" size="50" maxlength="50"></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
...
?>
        ...
        <input type="submit" name="Submit" value="Cadastrar Fornecedor"></td><td><div align="right"> </div></td>
