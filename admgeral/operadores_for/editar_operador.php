...
$sql = "SELECT * FROM operadores_for where nome = '$nome'";
$res = mysql_query($sql);
$reg = 0;
echo "<tr>";
while($linha=mysql_fetch_row($res)) {
...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF">              <select name="estab_pertence" id="estab_pertence">
...
?>
    ...
    <tr>
      ...
      <td><select name="cidadeatuacao" id="cidadeatuacao">
