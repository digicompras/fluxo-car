...
?>
    ...
    <tr>
      <td>Senha</td>
      <td><input class='class021' name="usuario" type="hidden" id="usuario" value="<? echo $usuario_op; ?>">        <input class='class02' name="senha" type="password" id="senha" value="<? echo $senha_op; ?>"></td>
