...
?>
    ...
    <tr>
      <td>Obs</td>
      <td><textarea class='class02' name="obs" cols="50" rows="7" id="obs"></textarea></td>
      <td valign="bottom">Implanta&ccedil;&atilde;o(&Uacute;nica)</td>
      <td valign="bottom"><strong>R$ 1.000,00</strong></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
