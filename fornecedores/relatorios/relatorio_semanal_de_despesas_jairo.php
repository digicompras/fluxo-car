...
?></td>
            ...
            <tr>
              ...
              <td ><? 
$sql = "select sum(valordespesa) as totallimpezapatio from prestacao_contas_comprovantes where datadespesa between '$datainicial' and '$datafinal' and categoriadespesa = 'LIMPEZA-PATIO' and modopagto = 'DINHEIRO' and statusenviocomp = 'enviado'";
$resultado=mysql_query($sql, $conexao);
$linha=mysql_fetch_array($resultado);
