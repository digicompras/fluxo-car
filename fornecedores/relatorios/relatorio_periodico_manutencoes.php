...
<p>&nbsp;</p>
	...
	<?
$sql = "SELECT * FROM ocorrencias where placa = '$placa' order by datamanutencao desc";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
<table width="100%" border="0" cellspacing="0">
  <tbody>
    ...
    <tr>
      <td width="26%" background="imagens_sistema/fundocelulas1.png" style="font-size: 36px">Data</td>
      <td width="23%" background="imagens_sistema/fundocelulas1.png" style="font-size: 36px"><? echo $datamanutencao; ?></td>
      <td width="21%" background="imagens_sistema/fundocelulas1.png" style="font-size: 36px">Hora</td>
      <td width="30%" background="imagens_sistema/fundocelulas1.png" style="font-size: 36px"><? echo $horamanutencao; ?></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="3" background="imagens_sistema/fundocelulas1.png" style="font-size: 36px"><? echo $condutor; ?></td>
    </tr>
    <tr>
      <td background="imagens_sistema/fundocelulas1.png" style="font-size: 36px">Tipo de Manutencao</td>
      <td background="imagens_sistema/fundocelulas1.png" style="font-size: 36px"><strong><font color="#0000FF"><strong><font color="#0000FF"><? echo $tipomanutencao; ?></font></strong></font></strong></td>
    ...
    <tr>
      <td background="imagens_sistema/fundocelulas1.png" style="font-size: 36px"><strong><font color="#0000FF"><strong><font color="#0000FF"><? echo $operador; ?></font></strong></font></strong></td>
    ...
    <tr>
      <td background="imagens_sistema/fundocelulas1.png" style="font-size: 36px">Detalhamento</td>
      <td colspan="3" background="imagens_sistema/fundocelulas1.png" style="font-size: 36px"><? echo $detalhamento; ?></td>
    </tr>
    <tr>
