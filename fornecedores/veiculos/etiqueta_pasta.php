...
?>
  ...
  <table width="80%" border="6" align="center">
    <tbody>
      <tr>
        <td align="center"><table width="80%" border="0" align="center" cellspacing="0">
          <tr>
            <td align="center"><strong>Ve&iacute;culo</strong></td>
            ...
            <td width="17%" align="center" rowspan="4" valign="top"><?
		...
		?>
              <span style="float: left; border: 1px solid #000;"><img src="<?php echo $aux; ?>"><br>
                <? echo "$veiculo<br>$placa"; ?></span></td>
          </tr>
          <tr>
            <td width="19%" align="center" valign="top"><? echo $veiculo; ?>
            ...
            <td width="19%" align="center" valign="top"><? echo $fornecedor; ?></td>
            <td width="14%" align="center" valign="top"><? echo $ano; ?>
              <input name="ano" type="hidden" id="ano" value="<? echo $ano; ?>"></td>
            <td width="15%" align="center" valign="top"><? echo $modelo; ?>
