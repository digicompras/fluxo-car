...
<table width="100%" border="0" cellspacing="0">
  <tbody>
    ...
    <tr>
      ...
      <td background="imagens_sistema/fundocelulas1.png" style="font-size: 36px"><? echo "<a href='$link_nf' target='_blank'>$nf</a>"; ?></td>
...
$valor_da_nf = $linha[10];
    ...
    <tr>
	  ...
	  <?  } ?>
    <tr>
      <td colspan="3" align="center" background="imagens_sistema/fundocelulas1.png" style="font-size: 36px"><form action="imprime_orcamento_para_cliente.php" method="post" name="form1" target="_blank">
        <strong> 
        <? if($codigo_orcamento==""){
...
$registros_de_pecas_utilizadas_na_manutencao = mysql_num_rows($res5);
	...
	?>
    <tr>
      <td background="imagens_sistema/fundocelulas2.png" style="font-size: 36px">Quantidade</td>
      <td background="imagens_sistema/fundocelulas2.png" style="font-size: 36px">Pe&ccedil;a</td>
      <td background="imagens_sistema/fundocelulas2.png" style="font-size: 36px">PART NUMBER</td>
    </tr>
	  <?  } } ?>
	  <?
...
$codigo_orcamento = $linha[29];
	...
	?>
    <tr>
      <td background="imagens_sistema/fundocelulas2.png" style="font-size: 36px"><strong><? echo "$quant_utilizada"; ?></strong></td>
      <td background="imagens_sistema/fundocelulas2.png" style="font-size: 36px"><strong><? echo "$nome_produto"; ?></strong></td>
      <td background="imagens_sistema/fundocelulas2.png" style="font-size: 36px"><strong><? echo "$referencia"; ?></strong></td>
    </tr>
	  <? } } ?>
	  <?
		if($codigo_orcamento==""){
